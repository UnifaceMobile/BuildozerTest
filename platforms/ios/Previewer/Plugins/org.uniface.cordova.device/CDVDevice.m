...
#define UNIFACE_VERSION_MIN_REQUIRED 10000

/* Return the string version of the decimal version */
#define CLIENT_VERSION [NSString stringWithFormat:@"%d.%d.%d", \
(UNIFACE_VERSION_MIN_REQUIRED / 10000),                 \
(UNIFACE_VERSION_MIN_REQUIRED % 10000) / 100,           \
(UNIFACE_VERSION_MIN_REQUIRED % 10000) % 100]
...
- (NSDictionary*)deviceProperties
{
    ...
    [devProps setObject:[[self class] clientVersion] forKey:@"clientVersion"];
